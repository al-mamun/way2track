        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Edit Delivery Details</li>
                </ol>
            </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
        	       ...
        	       <?php if(Session::has('success')): ?>
        	        ...
        	        <div class="modal fade" id="modal-lg">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">  Search Shipments </h4>
                     ...
                     <button class="btn btn-success assign_button" onclick="assign()"  data-toggle="modal" data-target="#modal-lg"> Add Shipments </button>
                ...
                <div class="card-body">
                    <div class="card card-primary">
                      <div class="card-header">
                        <h3 class="card-title">Edit Delivery Details</h3>
                      </div>
...
<?php echo $__env->make('admin.master.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mrh0idtypbzb/public_html/resources/views/admin/delivery/index.blade.php ENDPATH**/ ?>