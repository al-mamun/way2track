              ...
              <!-- /.card-header -->
                <div class="card-body">
                    <div class="card card-primary">
                      ...
                      <!-- /.card-header -->
                      <!-- form start -->
                      <?php echo Form::open(array('url'=>'create/delivery/submit','role'=>'form','method'=>'POST','class'=>'from-submit-status')); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                     <div class="form-group">
                                        ...
                                        <input type="text" required class="form-control" name="DELIVERY_ID" placeholder="" required value="<?php echo e($DELIVERYID); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
...
<?php echo $__env->make('admin.master.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mrh0idtypbzb/public_html/resources/views/admin/delivery/create.blade.php ENDPATH**/ ?>