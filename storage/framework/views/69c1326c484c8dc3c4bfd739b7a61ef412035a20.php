        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                  ...
                  <?php echo Form::open(array('url'=>'/list/purchase/order/assign/shipment/submit','role'=>'form','method'=>'POST','class'=>'from-submit-status', 'enctype'=>'multipart/form-data')); ?>
        		            ...
        		            <table class="table table-bordered " id="listShipment" border="1">
        		              ...
        		              <tbody>
            		             <?php $__currentLoopData = $newShipmentView; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            		               <tr id="shipment_id_<?php echo e($data->ID); ?>">
                    				  ...
                    				  <td style="background-color:#E8ECF1;" class="editACT_EXF_DATE" id="<?php echo e($data->ID); ?>">
                    				       <?php if(!empty($data->WAREHOUSE_DATE)): ?>
                            				    <?php 
                                            ...
                                            <?php else: ?>
                                                ...
                                                ?>
                                            <?php endif; ?>
                    						<span id="WAREHOUSE_DATE_<?php echo e($data->ID); ?>" class="text"><?php echo e($WAREHOUSE_DATE); ?></span>
                    						<input type="date" value="<?php echo e($WAREHOUSE_DATE); ?>" class="editbox" id="WAREHOUSE_DATE_input_<?php echo e($data->ID); ?>" style="display:none">
                    				  </td>
...
<?php echo $__env->make('admin.master.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mrh0idtypbzb/public_html/resources/views/admin/shipment-details/temp_assign_list.blade.php ENDPATH**/ ?>