...
<table id="tableResponsive2" class="table table-bordered table-hover table-responsive">
    ...
    <tbody>
    <?php $sl = 1; ?>
        <?php $__currentLoopData = $deliveryInfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $deliveryHeadersInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            
            <tr id="<?php echo e($deliveryInfo[$key]['SHIPMENT_ID']); ?>">
                ...
                ?>
                 <td >
                     <div class="check_box_wip_no">
                     	<input type="checkbox" id="SHIPMENT_ID" name="SHIPMENT_ID" value="<?php echo e($deliveryInfo[$key]['SHIPMENT_ID'].','. $deliveryInfo[$key]['PO_NO']); ?>">
					    <?php echo e($deliveryInfo[$key]['SHIPMENT_ID']); ?>

					 </div>
				  </td>
                 <td >
                  
                     <?php if(!empty( $deliveryInfo[$key]['PO_NO'])): ?>
                     <span class="po_no">
						<span id="PO_NO" class="text"><?php echo e($deliveryInfo[$key]['PO_NO']); ?></span>
						<input type="text" value="<?php echo e($deliveryInfo[$key]['PO_NO']); ?>" class="editbox" id="PO_NO_input" style="display:none">
					</span>
					<?php endif; ?>
				  </td>
...
</script><?php /**PATH /home/mrh0idtypbzb/public_html/resources/views/admin/delivery/assign.blade.php ENDPATH**/ ?>