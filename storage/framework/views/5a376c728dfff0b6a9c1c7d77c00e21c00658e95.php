        ...
        <tr id="purchase_id_<?php echo e($data->ID); ?>">
          <td style="display:none"><?php echo e($key + 1); ?></td>
           <td style="background-color:#E8ECF1;" class="edit_wip_no" id="<?php echo e($data->ID); ?>">
				<span id="wip_<?php echo e($data->ID); ?>" class="text po_box_text"><?php echo e($data->PO_NO); ?></span>
		  ...
		  <td style="background-color:#E8ECF1;" class="editITEM" id="<?php echo e($data->ID); ?>">
				<span id="ITEM_<?php echo e($data->ID); ?>" class="text item_box_text"><?php echo e($data->ITEM); ?></span>
		  ...
		  <td style="background-color:#E8ECF1;" class="editDESCRIPTION" id="<?php echo e($data->ID); ?>">
				<span id="DESCRIPTION_<?php echo e($data->ID); ?>" class="text description_box_text"><?php echo e($data->DESCRIPTION); ?></span>
		  ...
		  <td style="background-color:#E8ECF1;" class="editQty" id="<?php echo e($data->ID); ?>">
				<span id="QTY_<?php echo e($data->ID); ?>" class="text qty_box_text"><?php echo e($data->QTY); ?></span>
          ...
          <td style="background-color:#E8ECF1;" class="editCOMMENTS" id="<?php echo e($data->ID); ?>">
				<span id="COMMENTS_<?php echo e($data->ID); ?>" class="text comments_box_text" ><?php echo e($data->COMMENTS); ?></span>
...
<script src="<?php echo e(URL::asset( 'js/purchase_details.js')); ?>"></script><?php /**PATH /home/mrh0idtypbzb/public_html/resources/views/admin/order-purchase/details/list_filter.blade.php ENDPATH**/ ?>