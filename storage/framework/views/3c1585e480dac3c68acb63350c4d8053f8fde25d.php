		...
		<div class="container-login100" style="background-image: url('<?php echo e(URL::asset( 'login/images/bg-01.jpg')); ?>');">
			<div class="wrap-login100">
				 <?php echo Form::open(array('url'=>'login/custom','role'=>'form','method'=>'POST','class'=>'login100-form validate-form')); ?>
                    ...
                    <div ><?php if(isset($error)): ?> <h6 class="text-danger login_err">  <?php echo e($error); ?> </h6> <?php endif; ?></div>
					<div class="container-login100-form-btn">
						<button class="login100-form-btn">
							Login
						</button>
						<div class=""><div class=''>
					        <a class="login_btn" href="<?php echo e(route('socialite.redirect')); ?>" > <img  class='fa'  style='padding-top:0px !important; padding-right:10px margin-top: 0; :hover {color: yellow} !important' src='https://dev.way2track.com/wp-content/plugins/miniorange-login-openid/includes/images/icons/g.png'>Login with Google</a></div> <br>
                        </div>
					</div>
...
</html><?php /**PATH /home/mrh0idtypbzb/public_html/resources/views/admin/auth/user_login.blade.php ENDPATH**/ ?>