    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
        	   ...
        	   <?php if(!empty($salesOrderDetailsTemp)): ?>
        	   <?php echo Form::open(array('url'=>'/new/order/details/submit/temp','role'=>'form','method'=>'POST','class'=>'from-submit-status', 'enctype'=>'multipart/form-data')); ?>
                          ...
                          <!-- /.card-header -->
                            <div class="card-content">
            		            <table class="table table-bordered" border="1">
            		             ...
            		             <?php $__currentLoopData = $salesOrderDetailsTemp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            		               <tr>
                    				  ...
                    				  <td style="background-color:#E8ECF1;" class="editEXP_DELIVERYTEMP" id="<?php echo e($data->ID); ?>">
                    						<span id="EXP_DELIVERY_<?php echo e($data->ID); ?>" class="text"> <?php echo e(date("d M  Y", strtotime($data->EXP_DELIVERY))); ?></span>
                    				  ...
                    				  <td style="background-color:#E8ECF1;" class="editEXP_HANDOVER_DTTEMP" id="<?php echo e($data->ID); ?>">
                    						<span id="EXP_HANDOVER_DT_<?php echo e($data->ID); ?>" class="text"><?php echo e(date("d M  Y", strtotime($data->EXP_HANDOVER_DT))); ?></span>
                    				  ...
                    				  <td style="background-color:#E8ECF1;" class="editEX_COMMENTSTEMP" id="<?php echo e($data->ID); ?>">
                    				  ...
                    				  <td style="background-color:#E8ECF1;" class="editSUPPLIERTemp" id="<?php echo e($data->ID); ?>">
            		                  ...
            		                  <td style="background-color:#E8ECF1;" class="editThumbnailImage" id="<?php echo e($data->ID); ?>"> 
            		                        <!--<div id="image_upload_<?php echo e($data->ID); ?>">-->
            		                        <!--    <input type="file" value="<?php echo e($data->THUMBNAIL_IMAGE); ?>"  id="COMMENTS_input_<?php echo e($data->ID); ?>">-->
            		                        <!--</div>-->
    									  <?php 
            		                        ...
            		                        <?php if($total > 1): ?>
            		                            <a style="display: block; border:2px solid red" class="example-image-link" href="javacript:void(0)" data-lightbox="example-1">
        								            <img style="max-width: 80px; display: block;" class="example-image-link" src="<?php echo e(URL::asset( 'images/'. $data->THUMBNAIL_IMAGE)); ?>" >
        								        </a>
            		                        <?php else: ?>
...
<?php echo $__env->make('admin.master.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mrh0idtypbzb/public_html/resources/views/admin/order/details/list.blade.php ENDPATH**/ ?>