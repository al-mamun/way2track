              ...
              <!-- /.card-header -->
                <div class="card-body">
                    <div class="card card-primary">
                      ...
                      <!-- /.card-header -->
                      <!-- form start -->
                      <?php echo Form::open(array('url'=>'shipment/details/submit','role'=>'form','method'=>'POST','class'=>'from-submit-status')); ?>
...
<?php echo $__env->make('admin.master.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mrh0idtypbzb/public_html/resources/views/admin/shipment-details/create.blade.php ENDPATH**/ ?>