...
<<<<<<< HEAD
                    						<select type="hidden" name="CURRENCY" class="form-control  editbox" id="CURRENCY_input_{{ $data->ID }}" style="display:none">
...
=======
                    						<select name="CURRENCY" class="form-control  editbox" id="CURRENCY_input_{{ $data->ID }}" style="display:none">
                                                <option value="{{ $data->CURRENCY }}"> {{ $data->CURRENCY }}</option>
                                                <option value="AED">United Arab Emirates Dirham</option>
                                            <option value="AUD">Australian Dollar</option>
                                            <option value="CAD">Canadian Dollar</option>
