                            ...
                            <tr id="{{ $salesOrderInfo->WIP }}" class="@if(isset($request_id) && $request_id == $salesOrderInfo->ID) selected @endif">
                                ...
                                <td style="background-color:#E8ECF1;" class="PROJECTMANAGER_EMAIL_click" id="{{ $salesOrderInfo->ID }}">
                    		 	 ...
                    		 	 <td style="background-color:#E8ECF1;" class="INSTALLATION_TIME_click" id="{{ $salesOrderInfo->ID }}">
                    				...
                    				<input type="date" value="{{ $salesOrderInfo->INSTALLATION_TIME }}" class="editboxStatus" id="INSTALLATION_TIME_input_{{ $salesOrderInfo->ID }}" style="display:none">
                    		 	</td>
